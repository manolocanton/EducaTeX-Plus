...
Manuel Cantón Guillén desarrolló la aplicación EducaTeX como una aplicación gratuita. Este servicio es proporcionado por el desarrollador sin costo alguno y está destinado a ser utilizado tal cual.
